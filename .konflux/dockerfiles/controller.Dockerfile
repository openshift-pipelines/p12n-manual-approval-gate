...
LABEL \
    com.redhat.component="openshift-pipelines-manual-approval-gate-controller-rhel10-container" \
    ...
    name="openshift-pipelines/pipelines-manual-approval-gate-controller-rhel10" \
